...
public class Server
{
    ...
    private static UdpClient udpListener; // nomenclatura na classe
    ...
    private static void TCPConnectCallback(IAsyncResult _result)
    {
        ...
        Debug.Log($"Incoming connection from {_client.Client.RemoteEndPoint}..."); // IP e porta


        // começar com 1 para id de cliente
